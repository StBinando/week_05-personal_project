...
item_23= Item(album_14, "Vinyl", 15, 18.99, 0, 0)
item_24= Item(album_14, "CD", 7.50, 9.99, 0, 2)
...
item_38= Item(album_23, "CD", round(uniform(5,10),2), round(uniform(10,18),2), 0 ,0)
item_39= Item(album_24, "CD", round(uniform(5,10),2), round(uniform(10,18),2), 0 ,0)
item_40= Item(album_24, "Vinyl", round(uniform(5,10),2), round(uniform(10,18),2), 0 ,0)
item_41= Item(album_25, "Vinyl", round(uniform(5,10),2), round(uniform(10,18),2), 0 ,0)
item_42= Item(album_26, "Vinyl", round(uniform(5,10),2), round(uniform(10,18),2), 0 ,0)
item_43= Item(album_27, "Vinyl", round(uniform(5,10),2), round(uniform(10,18),2), 0, 0)
item_44= Item(album_28, "Vinyl", round(uniform(5,10),2), round(uniform(10,18),2), 0, 0)
item_45= Item(album_29, "Vinyl", round(uniform(5,10),2), round(uniform(10,18),2), 0, 0)
item_46= Item(album_29, "CD", round(uniform(5,10),2), round(uniform(10,18),2), 0, 0)
item_47= Item(album_30, "Vinyl", round(uniform(5,10),2), round(uniform(10,18),2), 0, 0)
item_48= Item(album_30, "CD", round(uniform(5,10),2), round(uniform(10,18),2), 0, 0)
item_49= Item(album_12, "CD", round(uniform(5,10),2), round(uniform(10,18),2), 0, 0)
